...
class Inventario:
    ...
    # busca la id del producto y lo elimina
    def elimina_producto(self, Id_producto):
        try:
            ...
            for i, producto in enumerate(self.lista_productos):
                # Verifica si la id del producto es igual a la id ingresada
    ...
    # Busca la id del producto y cambia la cantidad y precio si el usuario lo desea
    ...
    def muestra_inventario(self):
        try:
            if self.lista_productos:
                # Muestra cada producto en la lista de productos
                for producto in self.lista_productos:
                    print(producto)
            else:
